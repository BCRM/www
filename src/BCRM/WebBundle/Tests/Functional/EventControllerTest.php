...
class EventControllerTest extends WebTestCase
{
    ...
    public function thereShouldBeNoMoreTicketsThanCapacity()
    {
        ...
        $this->assertInArray('john.doe.1981@domain.com', array_map(function(Ticket $t) { return $t->getEmail(); }, $tickets));
        ...
        $this->assertEquals(3, count($tickets));
        $this->assertNotInArray('john.doe.1981@domain.com', array_map(function(Ticket $t) { return $t->getEmail(); }, $tickets));
    }
