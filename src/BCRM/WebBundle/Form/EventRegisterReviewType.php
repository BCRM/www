...
class EventRegisterReviewType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->setMethod('POST')
            ->add('norefund', 'choice', array('label' => 'Mir ist bekannt, dass im Falle einer Stornierung durch mich eine Bearbeitungsgebühr von 1 € anfällt:', 'required' => true, 'choices' => array(1 => 'ja', 0 => 'nein'), 'expanded' => true))
            ->add('autocancel', 'choice', array('label' => sprintf('Mir ist bekannt, dass meine Registrierung automatisch storniert wird, wenn ich den Gesamtbetrag nicht bis %s begleiche:', $model->getAutoCancelDate()->format('d.m.Y H:i')), 'required' => true, 'choices' => array(1 => 'ja', 0 => 'nein'), 'expanded' => true))
