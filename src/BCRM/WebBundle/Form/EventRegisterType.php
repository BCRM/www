...
class EventRegisterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('tags', 'text', array('label' => 'Beschreibe deine Interesse in maximal 3 Tags (je 15 Zeichen)', 'required' => false, 'attr' => array('placeholder' => '#foo #bar', 'pattern' => '#[^\s]{1,15}( #[^\s]{1,15}){0,2}')))
            ...
            ->add('food', 'choice', array('label' => 'Wie möchtest Du essen?', 'required' => true, 'choices' => array('vegan' => 'vegan', 'default' => 'egal'), 'expanded' => true))
